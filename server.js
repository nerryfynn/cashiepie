...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .floating-title i { font-size: 1.8rem; color: #e67e22; }
    ...
    .section-head { display: flex; align-items: center; gap: 12px; margin-bottom: 1.2rem; border-left: 4px solid #e67e22; padding-left: 1rem; }
    ...
    .footer-link:hover { color: #e67e22; }
    ...
    .login-card button { background: #e67e22; color: white; border: none; padding: 14px; width: 100%; border-radius: 60px; cursor: pointer; }
    ...
    .logout-btn { background: #e67e22; border: none; padding: 10px 28px; border-radius: 40px; color: white; cursor: pointer; }
...
<div id="loginOverlay" class="login-overlay">
  <div class="login-card">
    <i class="fas fa-chart-pie" style="font-size: 3rem; color:#e67e22;"></i>
    <h2>CashiePie</h2>
...
<div id="adminDashboard" class="admin-dashboard"><div class="admin-wrapper"><div class="admin-header"><h2><i class="fas fa-chart-pie" style="color:#e67e22;"></i> Admin Console</h2><button class="logout-btn" id="logoutAdminBtn">Exit Admin</button></div><div class="dashboard-stats" id="adminStats"></div><div class="chart-grid"><div class="chart-card"><canvas id="tslaChart"></canvas></div><div class="chart-card"><canvas id="allocationChart"></canvas></div></div><div class="user-table"><table id="adminUserTable"><thead><tr><th>Investor</th><th>Investment</th><th>Profit</th><th>Balance</th><th>Status</th></tr></thead><tbody id="adminTableBody"></tbody></table></div></div></div>
...
<div id="careModal" class="modal-overlay"><div class="modal-container"><div class="modal-header"><h3>Customer Care</h3><button class="close-modal" data-modal="careModal">×</button></div><div class="customer-care-info"><div class="care-option"><i class="fas fa-envelope"></i><span>support@cashiepie.com</span></div><div class="care-option"><i class="fas fa-phone-alt"></i><span>+1 (888) 555-0123</span></div><div class="care-option"><i class="fas fa-comment-dots"></i><span>Live chat: 9AM - 6PM EST</span></div><div class="care-option"><i class="fas fa-clock"></i><span>24/7 support</span></div></div></div></div>
